...
Future<dynamic> viewPerAccountPopup(BuildContext context,
    Datastore datastore,
  ...
  for (int i = 0; i <= entryList.length; i++) {
    ...
    if (entryDay != currentDay || i == entryList.length) {
      ...
      for (SpendingEntry item in tmpList) {
        if (item.recAccId == accountId) // Receive Transfer Entry
            {
          minHeight += 30;
          accountSpending.add(Container(
                    ...
                    child: Column(
                        ...
                        children: [
                          Container(
                              ...
                              child: Text(datastore.accountList.firstWhere((element) => element.id == accountId).caption,
                                  style: GoogleFonts.lato(
                                      textStyle: const TextStyle(
                                          fontSize: 18,
